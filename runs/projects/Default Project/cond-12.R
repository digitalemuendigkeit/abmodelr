...
config <- load_config("Default Project")[["cond-12.yml"]]
...
rds_filename <- paste0("12-1", "-", config$outputfilename)
...
rds_filename <- paste0("12-2", "-", config$outputfilename)
write_rds(path = here::here("runs", "projects", "Default Project", "results", rds_filename), x = results_data)
...
rds_filename <- paste0("12-3", "-", config$outputfilename)
write_rds(path = here::here("runs", "projects", "Default Project", "results", rds_filename), x = results_data)
...
rds_filename <- paste0("12-4", "-", config$outputfilename)
write_rds(path = here::here("runs", "projects", "Default Project", "results", rds_filename), x = results_data)
...
rds_filename <- paste0("12-5", "-", config$outputfilename)
write_rds(path = here::here("runs", "projects", "Default Project", "results", rds_filename), x = results_data)
...
rds_filename <- paste0("12-6", "-", config$outputfilename)
write_rds(path = here::here("runs", "projects", "Default Project", "results", rds_filename), x = results_data)
...
rds_filename <- paste0("12-7", "-", config$outputfilename)
write_rds(path = here::here("runs", "projects", "Default Project", "results", rds_filename), x = results_data)
...
rds_filename <- paste0("12-8", "-", config$outputfilename)
write_rds(path = here::here("runs", "projects", "Default Project", "results", rds_filename), x = results_data)
...
rds_filename <- paste0("12-9", "-", config$outputfilename)
write_rds(path = here::here("runs", "projects", "Default Project", "results", rds_filename), x = results_data)
...
rds_filename <- paste0("12-10", "-", config$outputfilename)
write_rds(path = here::here("runs", "projects", "Default Project", "results", rds_filename), x = results_data)
