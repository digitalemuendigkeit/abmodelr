...
config <- load_config("Default Project")[["cond-18.yml"]]
...
rds_filename <- paste0("18-1", "-", config$outputfilename)
...
rds_filename <- paste0("18-2", "-", config$outputfilename)
write_rds(path = here::here("runs", "projects", "Default Project", "results", rds_filename), x = results_data)
...
rds_filename <- paste0("18-3", "-", config$outputfilename)
write_rds(path = here::here("runs", "projects", "Default Project", "results", rds_filename), x = results_data)
...
rds_filename <- paste0("18-4", "-", config$outputfilename)
write_rds(path = here::here("runs", "projects", "Default Project", "results", rds_filename), x = results_data)
...
rds_filename <- paste0("18-5", "-", config$outputfilename)
write_rds(path = here::here("runs", "projects", "Default Project", "results", rds_filename), x = results_data)
...
rds_filename <- paste0("18-6", "-", config$outputfilename)
write_rds(path = here::here("runs", "projects", "Default Project", "results", rds_filename), x = results_data)
...
rds_filename <- paste0("18-7", "-", config$outputfilename)
write_rds(path = here::here("runs", "projects", "Default Project", "results", rds_filename), x = results_data)
...
rds_filename <- paste0("18-8", "-", config$outputfilename)
write_rds(path = here::here("runs", "projects", "Default Project", "results", rds_filename), x = results_data)
...
rds_filename <- paste0("18-9", "-", config$outputfilename)
write_rds(path = here::here("runs", "projects", "Default Project", "results", rds_filename), x = results_data)
...
rds_filename <- paste0("18-10", "-", config$outputfilename)
write_rds(path = here::here("runs", "projects", "Default Project", "results", rds_filename), x = results_data)
