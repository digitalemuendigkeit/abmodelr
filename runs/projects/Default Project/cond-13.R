...
config <- load_config("Default Project")[["cond-13.yml"]]
...
rds_filename <- paste0("13-1", "-", config$outputfilename)
...
rds_filename <- paste0("13-2", "-", config$outputfilename)
write_rds(path = here::here("runs", "projects", "Default Project", "results", rds_filename), x = results_data)
...
rds_filename <- paste0("13-3", "-", config$outputfilename)
write_rds(path = here::here("runs", "projects", "Default Project", "results", rds_filename), x = results_data)
...
rds_filename <- paste0("13-4", "-", config$outputfilename)
write_rds(path = here::here("runs", "projects", "Default Project", "results", rds_filename), x = results_data)
...
rds_filename <- paste0("13-5", "-", config$outputfilename)
write_rds(path = here::here("runs", "projects", "Default Project", "results", rds_filename), x = results_data)
...
rds_filename <- paste0("13-6", "-", config$outputfilename)
write_rds(path = here::here("runs", "projects", "Default Project", "results", rds_filename), x = results_data)
...
rds_filename <- paste0("13-7", "-", config$outputfilename)
write_rds(path = here::here("runs", "projects", "Default Project", "results", rds_filename), x = results_data)
...
rds_filename <- paste0("13-8", "-", config$outputfilename)
write_rds(path = here::here("runs", "projects", "Default Project", "results", rds_filename), x = results_data)
...
rds_filename <- paste0("13-9", "-", config$outputfilename)
write_rds(path = here::here("runs", "projects", "Default Project", "results", rds_filename), x = results_data)
...
rds_filename <- paste0("13-10", "-", config$outputfilename)
write_rds(path = here::here("runs", "projects", "Default Project", "results", rds_filename), x = results_data)
